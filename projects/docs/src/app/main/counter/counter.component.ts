...
@Component({
  ...
  template: `
    ...
    <p>
      This is the most minimal-simple example of a <strong>Counter</strong>.
    ...
    <p>
      A <strong>slice</strong> represents a piece of the
      <strong>global state</strong>. <code>createSlice</code> works based on two
      main things:
    </p>
    <ul class="tui-list">
      <li class="tui-list__item">
        <code>reducers</code>: used to generate the <code>ActionCreators</code>
      </li>
      <li class="tui-list__item">
        <code>initialState</code>: used to generate the
        <code>MemoizedSelectors</code>
      </li>
    </ul>
    <p>
      With <code>createSlice</code>, we express the
      <strong>State Updaters</strong> via <code>reducers</code>. Each case
      defined in <code>reducers</code> will act as the name of the generated
      <code>ActionCreator</code> respectively
    </p>
    <p>
      For example, <code>reducers.increment</code> will allow
      <code>createSlice</code> to generate <code>actions.increment()</code>
    </p>
